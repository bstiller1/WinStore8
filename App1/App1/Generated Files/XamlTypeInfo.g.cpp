...
::Windows::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider::CreateXamlType(::Platform::String^ typeName)
{
    ...
    if (typeName == L"App1.Common.LayoutAwarePage")
    {
    ...
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, GetXamlTypeByName(L"App1.Common.LayoutAwarePage"));
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Custom;
        userType->Activator =
            []() -> Platform::Object^ 
            {
    ...
    if (typeName == L"App1.Common.RichTextColumns")
    {
        ...
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::App1::Common::RichTextColumns(); 
            };
        userType->SetContentPropertyName(L"App1.Common.RichTextColumns.RichTextContent");
    ...
    if (typeName == L"App1.Data.SampleDataCommon")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, GetXamlTypeByName(L"App1.Common.BindableBase"));
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Custom;
    ...
    if (typeName == L"App1.Common.BindableBase")
    {
    ...
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, GetXamlTypeByName(L"App1.Data.SampleDataCommon"));
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Custom;
    ...
    if (typeName == L"Windows.Foundation.Collections.IVector<App1.Data.SampleDataItem>")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, nullptr);
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Metadata;
        userType->CollectionAdd =
            ...
            {
                auto collection = (Windows::Foundation::Collections::IVector<::App1::Data::SampleDataItem^>^)instance;
    ...
    if (typeName == L"Windows.Foundation.Collections.IObservableVector<App1.Data.SampleDataItem>")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, nullptr);
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Metadata;
        userType->CollectionAdd =
    ...
    if (typeName == L"App1.Data.SampleDataSource")
    {
        ...
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::App1::Data::SampleDataSource(); 
            };
    ...
    if (typeName == L"Windows.Foundation.Collections.IObservableVector<App1.Data.SampleDataGroup>")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, nullptr);
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Metadata;
        userType->CollectionAdd =
    ...
    if (typeName == L"Windows.Foundation.Collections.IIterable<App1.Data.SampleDataGroup>")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, nullptr);
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Metadata;
        return userType;
...
{
    if (longMemberName == L"App1.Common.LayoutAwarePage.DefaultViewModel")
    {
        ...
        xamlMember->Getter =
            ...
            {
                auto that = (::App1::Common::LayoutAwarePage^)instance;
    ...
    if (longMemberName == L"App1.Common.RichTextColumns.RichTextContent")
    {
        ...
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
                auto that = (::App1::Common::RichTextColumns^)instance;
    ...
    if (longMemberName == L"App1.Common.RichTextColumns.ColumnTemplate")
    {
    ...
    if (longMemberName == L"App1.Data.SampleDataCommon.Image")
    {
    ...
    if (longMemberName == L"App1.Data.SampleDataCommon.Subtitle")
    {
    ...
    if (longMemberName == L"App1.Data.SampleDataCommon.Title")
    {
    ...
    if (longMemberName == L"App1.Data.SampleDataCommon.UniqueId")
    {
    ...
    if (longMemberName == L"App1.Common.BindableBase.Type")
    {
        ...
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
                auto that = (::App1::Common::BindableBase^)instance;
    ...
    if (longMemberName == L"App1.Data.SampleDataItem.Group")
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"Group", L"App1.Data.SampleDataGroup");
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
        ...
        xamlMember->Setter =
            ...
            {
                auto that = (::App1::Data::SampleDataItem^)instance;
                that->Group = (::App1::Data::SampleDataGroup^)value;
            };
        return xamlMember;
    }
    ...
    if (longMemberName == L"App1.Data.SampleDataGroup.TopItems")
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"TopItems", L"Windows.Foundation.Collections.IVector<App1.Data.SampleDataItem>");
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
    ...
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"Items", L"Windows.Foundation.Collections.IObservableVector<App1.Data.SampleDataItem>");
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
                auto that = (::App1::Data::SampleDataGroup^)instance;
    ...
    if (longMemberName == L"App1.Data.SampleDataSource.AllGroups")
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"AllGroups", L"Windows.Foundation.Collections.IObservableVector<App1.Data.SampleDataGroup>");
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
    ...
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"Groups", L"Windows.Foundation.Collections.IIterable<App1.Data.SampleDataGroup>");
        xamlMember->SetTargetTypeName(L"String");
        xamlMember->SetIsAttachable();
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
                return ::App1::Data::SampleDataSource::GetGroups((::Platform::String^)instance);
            };
    ...
    if (longMemberName == L"App1.Data.SampleDataSource.Group")
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"Group", L"App1.Data.SampleDataGroup");
        xamlMember->SetTargetTypeName(L"String");
        xamlMember->SetIsAttachable();
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
                return ::App1::Data::SampleDataSource::GetGroup((::Platform::String^)instance);
            };
    ...
    if (longMemberName == L"App1.Data.SampleDataSource.Item")
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"Item", L"App1.Data.SampleDataItem");
        xamlMember->SetTargetTypeName(L"String");
        xamlMember->SetIsAttachable();
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
                return ::App1::Data::SampleDataSource::GetItem((::Platform::String^)instance);
            };
